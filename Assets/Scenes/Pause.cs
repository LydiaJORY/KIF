...
public class Pause : MonoBehaviour {
	...
	public bool isMainsMemeHauteur() {
		...
		print (
			(mainGauchePosition <= mainDroiteEcartMax).ToString() 
	...
	public void OnGUI () {
		...
		if (enPause) {
			...
			GUI.Box (new Rect (Screen.width / 2 - 100 / 2, Screen.height / 2 - 200, 100, 40), "Pause", KIF_Gui.customButton);
			print ("PAUSE");
